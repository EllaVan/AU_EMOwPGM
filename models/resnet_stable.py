...
class ResNet_EMO(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, include_top=True, zero_init_residual=False,
...
if __name__ == '__main__':
    res18 = ResNet_EMO(block=BasicBlock, n_blocks=[2, 2, 2, 2], channels=[64, 128, 256, 512], output_dim=1000)
