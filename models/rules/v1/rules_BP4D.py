...
def learn_rules(conf, device, input_info, input_rules, AU_p_d, summary_writer, *args):
    ...
    print('The current lr_relation is ', lr)
...
def test_rules(conf, device, input_info, input_rules, AU_p_d, summary_writer, *args):
...
def main_rules(conf, device, cur_path, info_source, AU_p_d):
    ...
    output_rules, output_records = learn_rules(conf, device, train_rules_input, input_rules, AU_p_d, summary_writer, change_w)
    ...
    output_records = test_rules(conf, device, val_rules_input, output_rules, AU_p_d, summary_writer)
